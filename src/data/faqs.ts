...
export const INITIAL_FAQS: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'অবশ্যই! যে কোনো ক্রুশবিদ্ধ ফুল, ডয়লি বা ঘর সাজানোর আইটেম আপনার পছন্দের রঙ বা সাইজ অনুযায়ী তৈরি করে দেওয়া যাবে। অর্ডারের সময় নোট বক্সে লিখে দিতে পারেন অথবা আমাদের হোয়াটসঅ্যাপে যোগাযোগ করে কাস্টম রিকুয়েস্ট জানাতে পারেন।'
  },
  {
    id: '6',
    category: 'return',
...
export const INITIAL_PROMOS = {
  banner1: {
    ...
    subtitle: 'প্রিয় ক্রুশবিদ্ধ সংগ্রহে পাচ্ছেন বিশেষ মূল্যছাড়',
    couponCode: 'NAHAR20',
